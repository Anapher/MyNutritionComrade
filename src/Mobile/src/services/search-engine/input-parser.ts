import { Conversion, ServingSize } from 'src/features/product-search/types';
...
/**
 * Interpret an input and try to parse an amount and a unit. Return the parsed result
